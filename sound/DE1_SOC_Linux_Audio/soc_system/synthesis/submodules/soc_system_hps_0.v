...
module soc_system_hps_0 #(
		...
		input  wire         f2h_dma_req2_req,         //      f2h_dma_req2.dma_req
		input  wire         f2h_dma_req2_single,      //                  .dma_single
		output wire         f2h_dma_req2_ack,         //                  .dma_ack
		input  wire         f2h_dma_req3_req,         //      f2h_dma_req3.dma_req
		input  wire         f2h_dma_req3_single,      //                  .dma_single
		output wire         f2h_dma_req3_ack,         //                  .dma_ack
	...
	soc_system_hps_0_fpga_interfaces fpga_interfaces (
		...
		.f2h_dma_req2_req    (f2h_dma_req2_req),    //      f2h_dma_req2.dma_req
		.f2h_dma_req2_single (f2h_dma_req2_single), //                  .dma_single
		.f2h_dma_req2_ack    (f2h_dma_req2_ack),    //                  .dma_ack
		.f2h_dma_req3_req    (f2h_dma_req3_req),    //      f2h_dma_req3.dma_req
		.f2h_dma_req3_single (f2h_dma_req3_single), //                  .dma_single
		.f2h_dma_req3_ack    (f2h_dma_req3_ack),    //                  .dma_ack
